...
class AUTOInteractive(object):
    def __init__(self,locals,filename=None):
        ...
        self.stopdemo = False
        self.oldhelp = builtins.help
        locals["help"] = self.help

        os_environ = os.environ["AUTO_DIR"]
        head, tail = os.path.split(os_environ)

        cmds_dir = os.listdir(head+"/cmds")
...
class AUTOInteractiveConsole(AUTOInteractive,code.InteractiveConsole):
    ...
    def _ofind(self, oname):
        ...
        for ns in [ self.locals, builtins.__dict__ ]:
